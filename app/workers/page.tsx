...
async function fetchWorkers(): Promise<WorkerDetails[]> {
  ...
  return [
    ...
    },
    {
      ...
      avgCpuTime: 28.7,
      avgDuration: 95.4,
      lastDeployment: '2026-01-29T14:15:00Z',
      routes: ['https://api.atlas.dev/*'],
      environment: 'production',
    },
    {
      id: 'gateway-proxy',
    ...
    },
    {
      ...
      avgCpuTime: 15.3,
      avgDuration: 52.8,
      lastDeployment: '2026-01-27T11:30:00Z',
      routes: ['https://webhooks.minte.dev/*'],
      environment: 'production',
    },
    {
      id: 'atlas-staging',
      name: 'atlas-dashboard-staging',
      status: 'healthy',
      requests24h: 420,
      errors24h: 2,
      errorRate: 0.48,
      avgCpuTime: 14.1,
      avgDuration: 48.5,
      lastDeployment: '2026-01-31T08:00:00Z',
      routes: ['https://staging.atlas.dev/*'],
      environment: 'staging',
    },
  ];
}
